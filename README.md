...
Чим краще?
- Ввід символів працює на любій розкладці, будь-то японська, чеська, німецька чи польська (на відміну від української Unicode-розкладки яку встановлюють віддільно, де ви матимете комбінації для символів ТІЛЬКИ на ній).
