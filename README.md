...
Чим краще?
- Ввід символів працює на **будь-якій розкладці** (на відміну від української Unicode-розкладки яку встановлюють віддільно, де ви матимете комбінації для символів **ТІЛЬКИ** на ній).
